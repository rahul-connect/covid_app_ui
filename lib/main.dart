              ...
              child: Row(
                children: <Widget>[
                  ...
                  Expanded(child: DropdownButton(
                    ...
                    value: "India",
                    items: ['India','USA','Italy'].map((String value){
                ...
                children: <Widget>[
                       ...
                       RichText(
                         text: TextSpan(
                           children: [TextSpan(text: "Case Update\n",style: kTitleTextStyle),
                              TextSpan(text: "Newest update April 18",style: TextStyle(
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        Counter(color: kInfectedColor,number: 1000,title: "Infected",),
                        Counter(color: kDeathColor,number: 310,title: "Deaths",),
                        Counter(color: kRecovercolor,number: 100,title: "Recovered",)
                      ],
                    ),
                  ),
                  SizedBox(height: 20,),
