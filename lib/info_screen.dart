      ...
      body: SingleChildScrollView(
          ...
          children: <Widget>[
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: <Widget>[
                Text("Symptons",style: kTitleTextStyle,),
                SizedBox(height: 20,),
                Row(
                ...
                PreventCard(
                  ...
                  text: "Since the start of the coronavirus outbread, Its advisable to wear mask all time",
                  title: "Wear Face mask",
                ),
                 PreventCard(
                  image: "assets/images/wash_hands.png",
                  text: "Since the start of the coronavirus outbread, Its advisable to wash hands often",
                  title: "Wear Face mask",
                ),
                SizedBox(height: 50,)
